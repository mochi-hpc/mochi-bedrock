 ...
 */
#ifndef __BEDROCK_REQUEST_RESULT_HPP
#define __BEDROCK_REQUEST_RESULT_HPP
...
template <> class RequestResult<std::string> {
  ...
  public:
    ...
    std::string& error() { return m_content; }

    const std::string& error() const { return m_content; }

    std::string& value() { return m_content; }
...
template <> class RequestResult<bool> {
  ...
  public:
    ...
    bool& value() { return m_success; }

    const bool& value() const { return m_success; }
