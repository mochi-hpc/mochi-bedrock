...
.. literalinclude:: ../../examples/bedrock/06_flock_integration/basic-config.json
   :language: json
...
.. literalinclude:: ../../examples/bedrock/06_flock_integration/distributed-config.json
   :language: json
...
.. literalinclude:: ../../examples/bedrock/06_flock_integration/client.cpp
   :language: cpp
...
.. literalinclude:: ../../examples/bedrock/06_flock_integration/python_example.py
   :language: python
